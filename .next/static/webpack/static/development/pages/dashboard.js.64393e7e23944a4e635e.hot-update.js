...
/*!*************************************************!*\
  !*** ./components/Dashboard/SentimentModule.js ***!
  \*************************************************/
/*! exports provided: default, getDailyTweetQ */
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getDailyTweetQ", function() { return getDailyTweetQ; });
...
function _templateObject() {
  var data = _taggedTemplateLiteral(["\n  query getDailyTweet($query: String!) {\n    getDailyTweet(query: $query) {\n      day\n      positive\n      negative\n      total\n    }\n  }\n"]);
...
function (_React$Component) {
  ...
  _createClass(SentimentModule, [{
    ...
    value: function render() {
      var getDailyTweetVars = {
        query: this.props.term
      };
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_apollo__WEBPACK_IMPORTED_MODULE_1__["Query"], {
        query: getDailyTweetQ,
        variables: getDailyTweetVars
      }, function (_ref) {
        ...
        //   console.log(data.getDailyTweet.negative);
        var myData = [{
          angle: 1
        }, {
          angle: 5
...
var getDailyTweetQ = graphql_tag__WEBPACK_IMPORTED_MODULE_2___default()(_templateObject());

/***/ })

})
//# sourceMappingURL=dashboard.js.64393e7e23944a4e635e.hot-update.js.map