...
function (_Component) {
  ...
  _createClass(_default, [{
    ...
    value: function handleSubmit(client) {
      ...
      Object(_helpers__WEBPACK_IMPORTED_MODULE_4__["getNotes"])(this.state.value).then(
      /*#__PURE__*/
      function () {
...
function (_Component2) {
  ...
  _createClass(AddHashtag, [{
    ...
    value: function handleChange(event) {
      console.log(event.target.value); // return event => {
      //   event.preventDefault();
...
//# sourceMappingURL=dashboard.js.cc384622ebf8a4105257.hot-update.js.map