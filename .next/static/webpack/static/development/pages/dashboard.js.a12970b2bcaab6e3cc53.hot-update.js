...
function (_PureComponent) {
  ...
  _createClass(Example, [{
    ...
    value: function componentDidUpdate(prevProps, nextProps) {
      console.log(prevProps); // console.log(this.props.store.currency);
      ...
      if (this.prevProps.store.hoursBack !== this.props.data.hourSentiment.time.length) {
        this.state.data = [];
        this.state.numTweets = 0;
...
//# sourceMappingURL=dashboard.js.a12970b2bcaab6e3cc53.hot-update.js.map