...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_App__WEBPACK_IMPORTED_MODULE_1__["default"], {
    ...
    __self: this
  }, "With more data than ever online, there's more opportunity than ever to gain an edge. We use state of the art machine learning classifiers such as ULMFIT and BERT to give our customers accurate sentiment data and more.")))))));
});
...
})(["display:flex;margin:0 10vw;height:100vh;background-color:", ";@media (max-width:1024px){margin:0 5vw;}@media (max-width:768px){display:block;margin:0;}"], function (props) {
  return props.theme.foreground;
});
...
})(["", " max-width:300px;font-size:15px;text-align:center;margin:auto;"], _components_shared_helpers__WEBPACK_IMPORTED_MODULE_7__["wideFont"]);
...
})(["", " max-width:300px;font-size:15px;color:#454f5b;text-align:center;margin:auto;"], _components_shared_helpers__WEBPACK_IMPORTED_MODULE_7__["wideFont"]);
...
})(["width:100%;min-height:400px;margin-top:100px;margin-bottom:80px;background:#1b1b1b;border-radius:2px;"]);
...
//# sourceMappingURL=index.js.b3de57da1b5010a6bdc1.hot-update.js.map