...
var SidebarCategoryList = Object(mobx_react__WEBPACK_IMPORTED_MODULE_2__["inject"])("store")(Object(mobx_react__WEBPACK_IMPORTED_MODULE_2__["observer"])(function (_ref) {
  ...
  if (store) {
    // let theStore = store;
    console.log(store.startDate + "START"); // store.startDate = "helloy";
    // console.log(store.startDate + "THIS STORE");
  } // const clicked = () => {
...
//# sourceMappingURL=dashboard.js.399f6adee2943a5a538f.hot-update.js.map