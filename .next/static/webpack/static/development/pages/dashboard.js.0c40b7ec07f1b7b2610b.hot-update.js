...
function (_PureComponent) {
  ...
  _createClass(Example, [{
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      console.log(this.state.datLength, this.props.data.hourSentiment.num_tweets.length);

      if (this.state.datLength !== this.props.data.hourSentiment.num_tweets.length) {
        this.state.data = [];
        this.state.numTweets = 0;
        this.state.datLength = this.props.data.hourSentiment.num_tweets.length;
...
//# sourceMappingURL=dashboard.js.0c40b7ec07f1b7b2610b.hot-update.js.map