...
/* harmony default export */ __webpack_exports__["default"] = (function (_ref) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_vx_shape__WEBPACK_IMPORTED_MODULE_1__["Bar"], {
    key: "".concat(barGroup.index, "-").concat(bar.index, "-").concat(bar.key),
    x: bar.x,
    y: bar.y,
    width: bar.width,
    height: bar.height,
    ...
    onClick: function onClick(event) {
      alert("".concat(bar.key, " (").concat(bar.value, ") - ").concat(JSON.stringify(bar)));
    }
...
//# sourceMappingURL=dashboard.js.58998b94acb88fb367b9.hot-update.js.map