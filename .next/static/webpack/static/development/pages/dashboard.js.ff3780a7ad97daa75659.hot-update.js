...
function (_Component) {
  ...
  _createClass(_default, [{
    ...
    value: function handleSubmit(client) {
      ...
      Object(_helpers__WEBPACK_IMPORTED_MODULE_4__["getNotesHashtags"])(this.state.value).then(
      /*#__PURE__*/
      function () {
...
function (_Component2) {
  ...
  _createClass(AddHashtag, [{
    ...
    value: function handleSubmit(client) {
      ...
      // console.log("HASHTAGS", this.state.hashtags);
      Object(_helpers__WEBPACK_IMPORTED_MODULE_4__["getHashtags"])(this.state.value, this.state.hashtags).then(
      /*#__PURE__*/
      function () {
...
//# sourceMappingURL=dashboard.js.ff3780a7ad97daa75659.hot-update.js.map