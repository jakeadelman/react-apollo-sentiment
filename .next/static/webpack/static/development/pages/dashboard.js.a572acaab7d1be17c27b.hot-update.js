...
function (_PureComponent) {
  ...
  _createClass(Example, [{
    ...
    value: function setStoreHours(e) {
      console.log(e.target.value); // this.setState({ data: [] });
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      if (!!this.state.data && this.state.data.numTweets.length !== this.props.data.numTweets.length) {
        this.state.data = [];
        this.state.numTweets = 0;
...
//# sourceMappingURL=dashboard.js.a572acaab7d1be17c27b.hot-update.js.map