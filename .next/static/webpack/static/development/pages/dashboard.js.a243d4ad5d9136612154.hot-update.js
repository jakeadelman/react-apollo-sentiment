...
function (_PureComponent) {
  ...
  _createClass(Example, [{
    ...
    value: function componentDidUpdate(prevProps, nextProps) {
      console.log(prevProps, nextProps); // console.log(this.props.store.currency);
      ...
      if (prevProps.store.hoursBack !== this.props.data.hourSentiment.time.length) {
        this.state.data = [];
        this.state.numTweets = 0;
...
//# sourceMappingURL=dashboard.js.a243d4ad5d9136612154.hot-update.js.map