    ...
    value: function render() {
      return external_react_default.a.createElement(external_react_apollo_["Query"], {
        ...
        var loading = _ref.loading,
            error = _ref.error,
            data = _ref.data;
        if (error) return external_react_default.a.createElement("div", null, "you are not allowed to access this page");
...
function (_React$Component) {
  ...
  dashboard_createClass(_default, [{
    key: "render",
    value: function render() {
      return external_react_default.a.createElement("div", null, external_react_default.a.createElement(DashMain_default, null));
    }
  }]);
