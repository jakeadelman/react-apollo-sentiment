export default () => {
  return (
    <div>
      ...
      <p>Effective date: February 08, 2019</p>

      <p>
        Social Slant ("us", "we", or "our") operates the https://socialslant.io
      ...
      <p>
        ...
        have associated with that data. The Privacy Policy for Social Slant has
      ...
      <p>
        ...
        in our Terms and Conditions, accessible from https://socialslant.io
      </p>
      ...
      <ul>
        <li>
          ...
          <p>
            Service is the https://socialslant.io website operated by Social
            Slant
          </p>
        </li>
        <li>
      ...
      <p>Social Slant uses the collected data for various purposes:</p>
      <ul>
      ...
      <p>
        Social Slant will take all steps reasonably necessary to ensure that
      ...
      <p>
        Social Slant may disclose your Personal Data in the good faith belief
        that such action is necessary to:
      </p>
      <ul>
        <li>To comply with a legal obligation</li>
        <li>To protect and defend the rights or property of Social Slant</li>
        <li>
      ...
      <ul>
        <li>By email: support@socialslant.io</li>
      </ul>
    </div>
  );
};
